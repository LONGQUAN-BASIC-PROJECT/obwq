 ...
 */
public class SingleMeiziParseImpl implements ParseArticlesHandler {
    ...
    public List<Article> parser(String pageContent, SechCrawDto sechCrawDto) {
        ...
        for(int i = 0 ; i < titlesEla .size() ;i++){
            ...
            String imageUrl = imageEl.select("#picture p img").first().attr("src");
            ...
            String fileKey = getCloundFile(pageContent) ;
    ...
    public String getCloundFile(String pageContent){
        Document jsoup =  Jsoup.parse(pageContent);
    ...
    public static void main(String[] s) throws Exception{
        ...
        new SingleMeiziParseImpl().parser(pageContent,null  );
    }
